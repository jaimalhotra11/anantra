    ...
    <div className="w-full max-w-2xl mx-auto select-none font-sans">
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        {images.length > 1 && (
          <div
            ref={thumbsRef}
            className="hidden lg:flex flex-col gap-2 overflow-y-auto max-h-[600px] scrollbar-hide"
          ...
          >
            {images.map((src, i) => (
              <button
                ...
                className={`relative shrink-0 w-20 h-20 rounded-xl overflow-hidden border-2 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-800 ${
                  i === activeIndex
        ...
        <div className="flex-1">
          {/* ── Main image ─────────────────────────────────────────────────────── */}
          <div
            className={`relative h-[400px] lg:h-[600px] w-full ${aspectClass} rounded-2xl overflow-hidden group`}
            ref={mainRef}
          ...
          {images.length > 1 && (
            <div
              ref={thumbsRef}
              className="lg:hidden flex gap-2 mt-3 overflow-x-auto pb-1 scrollbar-hide"
